...
describe('favorite blog', () => {
    test('null argument gives null result', () => {
        const result = listHelper.favoriteBlog()
        assert.strictEqual(result, null)
    })

    test('if there is only one blog, it is the favorite', () => {
...
describe('most blogs by author', () => {
    ...
    test('list with one entry gives the author of the only entry', () => {
        ...
        assert.partialDeepStrictEqual(result, {author: 'Edsger W. Dijkstra', blogs: 1})
    })
